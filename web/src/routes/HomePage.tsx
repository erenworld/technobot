...
export function HomePage() {
  const [tick, setTick] = useState(getRemaining);
  const [tab, setTab] = useState<'college' | 'lycee'>('college');
    ...
    <>
      ...
      <header className="hero">
        ...
        <h1>
          ...
          de robots
          <br />
          <span className="accent">autonomes.</span>
        </h1>

        <p className="hero-lead">
          Collèges et lycées de l'Académie <strong>Nancy-Metz</strong>{' '}
          s'affrontent le temps d'une journée. Suivi de ligne, sumo, formule
          robot, design. <strong>Une seule finale</strong>, au gymnase Mermoz.
        </p>
      ...
      <section className="countdown-wrap">
        <div className="countdown-card reveal">
          <div>
            <div className="cd-label">// Finale · J-{tick.d}</div>
            ...
            <p className="cd-sub">
              Accueil des équipes dès 8h00 · Premières épreuves à 9h30
            </p>
          </div>
          <div className="countdown" role="timer" aria-live="polite">
            <div className="cd-unit">
              <span className="cd-num">{pad(tick.d)}</span>
              <div className="cd-txt">jours</div>
            </div>
            <div className="cd-unit">
              <span className="cd-num">{pad(tick.h)}</span>
              <div className="cd-txt">heures</div>
            </div>
            <div className="cd-unit">
              <span className="cd-num">{pad(tick.m)}</span>
              <div className="cd-txt">min</div>
            </div>
            <div className="cd-unit">
              <span className="cd-num">{pad(tick.s)}</span>
        ...
        <div className="container">
          <div className="section-head reveal">
            <div>
              ...
              <h2 className="section-title">
                Un concours entre élèves. Pas une démo de kits.
              </h2>
            </div>
            <p className="section-note">
              Depuis 2012, TECHNOBOT réunit collégiens et lycéens autour
              d'épreuves qui demandent vraiment de concevoir, souder, programmer
          ...
          <div className="about-grid">
            <p className="about-text reveal">
              Les élèves sont <em>les seuls</em> acteurs de l'étude, la
              conception, la réalisation et la programmation. Un robot, une
              équipe, une épreuve. <em>Règle d'or :</em> si un prof ou un kit
              l'a fait, le robot est disqualifié.
            </p>
        ...
        <div className="container">
          <div className="section-head reveal">
            <div>
              ...
              <h2 className="section-title">
                Six manières de gagner, zéro moyen de tricher.
              </h2>
            </div>
            <p className="section-note">
              Un contrôle technique ouvre la journée. Des vérifications
              inopinées peuvent intervenir à tout moment. Les finalistes
              reprogramment en parc fermé.
            </p>
          </div>
          ...
          <div className="events-tabs reveal" role="tablist">
            ...
            <button
              type="button"
              className={tab === 'lycee' ? 'active' : ''}
              role="tab"
              onClick={() => setTab('lycee')}
            >
              Lycées
            </button>
          </div>
          ...
          <div
            className={`events-grid event-panel${tab === 'college' ? ' active' : ''}`}
          >
            <article className="event reveal">
              <div className="event-num">01 / Collèges</div>
              <h3>Suivi de ligne</h3>
              <p>
                Un tracé noir sur fond blanc, 9 mètres, et le chrono qui tourne.
                Plus six pistes bonus (angle aigu, intersection, interruptions)
              ...
              <div className="event-arrow">
                <svg width={14} height={14} viewBox="0 0 24 24" fill="none" stroke="#0E0E10" strokeWidth={2}>
            ...
            <article className="event reveal">
              ...
              <h3>Formule robot</h3>
              <p>
                Course de vitesse à deux, ovale, trois tours. Le premier à
                boucler ou à rattraper l'adversaire l'emporte. Les lignes
                rouges, c'est la sortie.
              </p>
              <div className="event-tags">
            ...
            <article className="event reveal">
              ...
              <h3>Design</h3>
              <p>
                Notation sur 120 : ergonomie, homogénéité, œuvre originale,
                qualité de l'affiche. Bonus 10 pts si le robot suit une piste
                ovale, 10 pts s'il est connecté.
              </p>
              <div className="event-tags">
            ...
            <article className="event reveal">
              ...
              <p>
                Trois minutes, un diaporama, des schémas SysML. Aisance,
                langue, justesse technique. Après trois minutes exactes, le
                micro se coupe.
              </p>
              <div className="event-tags">
          ...
          <div
            className={`events-grid event-panel${tab === 'lycee' ? ' active' : ''}`}
          >
            <article className="event reveal">
              <div className="event-num">05 / Lycées</div>
              <h3>Sumo autonome</h3>
              <p>
                Deux robots, un Dohyo de 92 cm. Expulser l'adversaire ou marquer
                au Yuko. Trois rencontres de trois minutes. Position de départ
                tirée au sort.
              </p>
              <div className="event-tags">
            ...
            <article className="event reveal">
              ...
              <p>
                Cinq minutes face à un jury bilingue, plus trois minutes
                d'interrogation technique. Dossier de 5 à 10 pages en LV, pitch
                écrit à déposer à l'arrivée.
              </p>
              <div className="event-tags">
      ...
      <section className="timeline">
        <div className="container">
          <div className="section-head reveal">
            ...
            <p className="section-note">
              Tout est calé sur la finale du 5 juin. Les retards d'inscription
              ne passent pas.
            </p>
          </div>
          ...
          <div className="tl-list reveal">
            <div className="tl-item past">
              ...
              <div className="tl-desc">
                Date limite pour remonter une fiche à Arnaud ROESSLINGER.
              </div>
            </div>
            <div className="tl-item current">
              ...
              <div className="tl-desc">
                Manches organisées dans toute l'Académie selon inscriptions.
              </div>
            </div>
            <div className="tl-item">
              ...
              <div className="tl-desc">
                Vérification des robots, dimensions, masse, coût max 100€.
              </div>
            </div>
            <div className="tl-item">
              ...
              <div className="tl-desc">
                Ouverture au public. Remise des trophées TECHNOBOT.
              </div>
            </div>
          </div>
        </div>
          ...
          <div className="location-grid">
            ...
            <div className="map-svg reveal">
              <svg viewBox="0 0 400 300" xmlns="http://www.w3.org/2000/svg">
                ...
                <path
                  d="M 280 300 L 260 120 L 400 100"
                  stroke="#0E0E10"
                  strokeWidth={3}
                  strokeLinecap="round"
                  strokeDasharray="4 3"
      ...
      <section className="partners">
        <div className="container">
          <div className="partners-label reveal">
            // ORGANISATEURS ET PARTENAIRES DE LA FINALE
          </div>
          <div className="partners-list reveal">
            <div className="partner-cell">
              TechTic<span className="red">&amp;</span>Co<small>Organisation</small>
            </div>
            <div className="partner-cell">
              UIMM Lorraine<small>Fabrique de l'avenir</small>
            </div>
            <div className="partner-cell">
              Collège J. Mermoz<small>Yutz</small>
            </div>
            <div className="partner-cell">
              La Briquerie<small>Lycée des sciences</small>
            </div>
            <div className="partner-cell">
              Académie<small>Nancy-Metz</small>
            </div>
            <div className="partner-cell">
